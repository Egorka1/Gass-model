...
MFCApplication6.h
    ...
    Он содержит прочие заголовки, относящиеся к проекту (включая Resource.h), а также объявляет класс приложения CMFCApplication6App.

MFCApplication6.cpp
    Это основной исходный файл приложения, в котором содержится класс приложения CMFCApplication6App.
...
MFCApplication6Dlg.h, MFCApplication6Dlg.cpp — диалоговое окно
    Эти файлы содержат класс CMFCApplication6Dlg. Этот класс определяет поведение главного диалогового окна приложения. Шаблон диалогового окна находится в файле MFCApplication6.rc, который можно изменять с помощью Microsoft Visual C++.
